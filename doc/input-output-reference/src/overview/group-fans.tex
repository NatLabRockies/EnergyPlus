...
This numeric field is the design volume flow rate of the fan as installed in the HVAC system, in m\(^{3}\)/s. This volume flow rate is converted to a mass flow rate using the altitude-adjusted standard density of dry air at 20~°C dry-bulb temperature. This is the full-speed flow rate and is the upper limit for fans that can vary their flow rate. This field can be autosized.
