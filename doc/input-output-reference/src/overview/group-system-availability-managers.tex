...
The fraction (could be greater than 1) of the design flow rate requested for night ventilation. The default is 1. If a \hyperref[fanperformancenightventilation]{FanPerformance:NightVentilation} object is specified for the fan, that object's Maximum Flow Rate field may further limit the fan flow rate used during night ventilation.
