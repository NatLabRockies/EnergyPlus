...
public: // Static Methods
  ...
  static size_type allocation_size(size_type const n) {
#ifdef OBJEXXFCL_ALIGN
    constexpr size_type alignment_overhead(
        OBJEXXFCL_ALIGN > 0u ? OBJEXXFCL_ALIGN - 1u : 0u);
#else
  ...
  static void *allocate(size_type const n) {
  ...
  static void *allocate_zero(size_type const n) {
  ...
  static T *data(void *const mem) {
#ifdef OBJEXXFCL_ALIGN
    T *p(static_cast<T *>(
        (mem == nullptr) || (OBJEXXFCL_ALIGN == 0u)
            ? mem
            : reinterpret_cast<void *>(
                  (reinterpret_cast<std::uintptr_t>(mem) +
                   static_cast<std::uintptr_t>(OBJEXXFCL_ALIGN - 1)) &
                  ~static_cast<std::uintptr_t>(OBJEXXFCL_ALIGN - 1))));
    assert(p >= mem);
